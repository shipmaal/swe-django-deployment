...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sem_eight', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='planner_sem_eight', to='planner.semester')),
                ('sem_five', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='planner_sem_five', to='planner.semester')),
                ('sem_four', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='planner_sem_four', to='planner.semester')),
                ('sem_one', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='planner_sem_one', to='planner.semester')),
                ('sem_seven', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='planner_sem_seven', to='planner.semester')),
                ('sem_six', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='planner_sem_six', to='planner.semester')),
                ('sem_three', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='planner_sem_three', to='planner.semester')),
                ('sem_two', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='planner_sem_two', to='planner.semester')),
        ...
        migrations.AddField(
            model_name='course',
            name='subject_area',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='planner.subjectarea'),
        ),
    ]
